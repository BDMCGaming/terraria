...
func registerCommonAuthenticationServerProtocols() {
	...
	commonTicketGrantingProtocol.ConfigurePNValidation([]string{"10198F00"})
	...
	secureStationURL.SetAddress(os.Getenv("PN_TERRARIA_SECURE_SERVER_HOST"))
	...
	commonTicketGrantingProtocol.BuildName = types.NewString("branch:origin/release/ngs/3.8.x.200x build:3_8_15_2004_0")
